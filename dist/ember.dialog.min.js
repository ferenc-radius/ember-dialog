...
Ember.TEMPLATES["components/dialog"]=Ember.Handlebars.compile('<div class="dialog-dialog component-dialog-dialog {{className}} {{substrate}}">    <div class="dialog-content" tabindex="-1">        {{view body}}    </div></div>');
